...
Trả về JSON THUẦN (không markdown bọc):
{
  ...
  "markdown_report": "báo cáo đầy đủ định dạng markdown, có footnote [^1] [^2] cuối bài"
}`;
}
...
Trả về JSON THUẦN:
{
  ...
  "markdown_report": "báo cáo chi tiết bằng tiếng Việt hành chính, có số liệu cụ thể, có footnote [^1]..."
}`;
}
