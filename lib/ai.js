...
async function call({
  ...
  maxTokens = 8000,
  expectJson = true,
  reasoningEffort = 'minimal' // GPT-5 only: 'minimal' | 'low' | 'medium' | 'high'
}) {
  ...
  // GPT-5 family: dùng max_completion_tokens + reasoning_effort (tránh reasoning lâu → timeout Vercel)
  // GPT-4 family: dùng max_tokens cổ điển
